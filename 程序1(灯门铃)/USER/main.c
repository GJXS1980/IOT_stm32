...
// 编译lighting1
	...
	cJSON_AddItemToObject(root,"lighting1",cJSON_CreateNumber(state));
	cJSON_AddItemToObject(root,"brightness1",cJSON_CreateNumber(PWM));
	...
	cJSON_AddItemToObject(root,"door1",cJSON_CreateNumber(state));
...
#if Lighting_IOT_1				
				case lighting_1:
						 Item = cJSON_GetObjectItem(root,"lighting_1");
						 if(Item != NULL)
						 {
...
#if Door_IOT_1							 
				case door_1:
						 Item = cJSON_GetObjectItem(root,"door_1");
						 if(Item != NULL)
						 {
