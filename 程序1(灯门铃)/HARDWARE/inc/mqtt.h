...
#define  PRODUCTKEY           "a19EYxYfg19"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "HG-light-001"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "64dadebfdaeb0194583b3da519fd002e"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/broadcast/a19EYxYfg19/IOTmsg"   												//接受广播信息  
#define  P_TOPIC_NAME         "/broadcast/a19EYxYfg19/IOTmsg"    											//发送广播
#define  APP_TOPIC_NAME       "/sys/a19EYxYfg19/HG-light-001/thing/event/property/post"    //需要发布的主题 	
...
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "223b5dac03d3b9f666c56fcde4fa911f"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/broadcast/a19EYxYfg19/IOTmsg"   												//接受广播信息  
#define  P_TOPIC_NAME         "/broadcast/a19EYxYfg19/IOTmsg"    											//发送广播
#define  APP_TOPIC_NAME       "/sys/a19EYxYfg19/HG-door/thing/event/property/post"    //需要发布的主题 	
