...
#if  Trashcan_IOT					
				if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"PowerSwitch_1\":1}"))
				{	                                                 
					Trashcan_State(1);
	
				}else if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"PowerSwitch_1\":0}"))
				{ 				
					Trashcan_State(0);
						
				}
				else if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"reset\":1}"))
				{
						 Trashcan_reset();					
				}else if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"stop\":1}"))
				{
						Trashcan_stop();		
...
#if  Lighting_IOT					
				if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"LightingSwitch_3\":1}"))
				{ 

					Lighting_State(1);
						
				}else if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"LightingSwitch_3\":0}"))
				{ 
...
#if  Door_IOT				
			if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"PowerSwitch_3\":1}"))
				{ 
					
					Door_State(1);  
					
				}else if(strstr((char *)MQTT_CMDOutPtr+2,"\"params\":{\"PowerSwitch_3\":0}"))
				{ 
...
//	u1_printf("CNT2=%d\r\n",TIM2->CNT);
	...
	if(state) sprintf(temp,"{\"method\":\"thing.event.property.post\",\"id\":\"203302322\",\"params\":{\"PowerSwitch_1\":1},\"version\":\"1.0.0\"}");  
	else            sprintf(temp,"{\"method\":\"thing.event.property.post\",\"id\":\"203302322\",\"params\":{\"PowerSwitch_1\":0},\"version\":\"1.0.0\"}");  
...
void Door_State(int state)
{
	...
	old_data = state;
	new_data = old_data;
	if(new_data) sprintf(temp,"{\"method\":\"thing.event.property.post\",\"id\":\"203302311\",\"params\":{\"PowerSwitch_3\":1},\"version\":\"1.0.0\"}");  
	else         sprintf(temp,"{\"method\":\"thing.event.property.post\",\"id\":\"203302311\",\"params\":{\"PowerSwitch_3\":0},\"version\":\"1.0.0\"}");  
...
void light_update(int state)
{
	...
	if(state) sprintf(temp,"{\"method\":\"thing.event.property.post\",\"id\":\"203302320\",\"params\":{\"LightingSwitch_3\":1},\"version\":\"1.0.0\"}");  
	else            sprintf(temp,"{\"method\":\"thing.event.property.post\",\"id\":\"203302320\",\"params\":{\"LightingSwitch_3\":0},\"version\":\"1.0.0\"}");  
