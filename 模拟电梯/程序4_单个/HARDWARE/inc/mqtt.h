...
#define  PRODUCTKEY           "a1dhixlMRVW"                                        //产品ID
...
#define  DEVICESECRE          "965c8259304bedee6dbef44b21f86cf2"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"   												//接受广播信息  
#define  P_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"    											//发送广播
#define  APP_TOPIC_NAME       "/sys/a1dhixlMRVW/HG-Curtain/thing/event/property/post"    //需要发布的主题 	
...
#define  PRODUCTKEY           "a1dhixlMRVW"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "HG-light-003"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "d172f4de3d65b2885b4b0dda974fe9b6"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"   												//接受广播信息  
#define  P_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"    											//发送广播
#define  APP_TOPIC_NAME       "/sys/a1dhixlMRVW/HG-light-003/thing/event/property/post"    //需要发布的主题 	
...
#define  S_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"   												//接受广播信息  
#define  P_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"    											//发送广播
#define  APP_TOPIC_NAME       "/sys/a1dhixlMRVW/HG-door/thing/event/property/post"    //需要发布的主题 	
...
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "5d2aeae6d0cf6521d1812dbbf2d7c558"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"   												//接受广播信息  
#define  P_TOPIC_NAME         "/broadcast/a1dhixlMRVW/IOTmsg"    											//发送广播
#define  APP_TOPIC_NAME       "/sys/a1dhixlMRVW/HG-Gateway/thing/event/property/post"    //需要发布的主题 	
